 ...
 * MaulssLib
 * 
 * Created on 08 February 2015 at 2:52 PM.
 */

package com.maulss.enhancedlib.net.http;
...
public class HttpRequest implements Closeable {
	 ...
	 * @param url    the URL
	 */
	private HttpRequest(@NotNull String method,
						@NotNull URL url) {
	 ...
	 * @return this object
	 */
	public HttpRequest body(@NotNull String data) {
	 ...
	 * @return this object
	 */
	public HttpRequest bodyForm(@NotNull Form form) {
	 ...
	 * @return this object
	 */
	public HttpRequest header(@NotNull String key,
	 ...
	 * @throws InterruptedException on interruption
	 */
	public HttpRequest saveContent(@NotNull File file) throws IOException, InterruptedException {
	 ...
	 * @throws InterruptedException on interruption
	 */
	public HttpRequest saveContent(@NotNull OutputStream out) throws IOException, InterruptedException {
	 ...
	 */
	public static HttpRequest get(@NotNull URL url) {
		return request("GET", Validate.notNull(url));
	}
	 ...
	 * @return a new request object
	 */
	public static HttpRequest post(@NotNull URL url) {
		return request("POST", Validate.notNull(url));
	}
	 ...
	 * @return a new request object
	 */
	public static HttpRequest request(@NotNull String method,
									  @NotNull URL url) {
		return new HttpRequest(Validate.notNull(method), Validate.notNull(url));
	}
	...
	public static URL url(@NotNull String url) {
		try {
			return new URL(Validate.notNull(url));
	 ...
	 */
	private static URL reformat(@NotNull URL existing) {

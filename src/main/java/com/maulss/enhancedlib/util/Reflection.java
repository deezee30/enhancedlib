 ...
 * MaulssLib
 * 
 * Created on 28 December 2014 at 3:07 PM.
 */
...
public final class Reflection {
	 ...
	 */
	private static final Map<Class<?>, Map<String, Map<Wrapper<Class<?>[]>, Method>>> loadedMethods = new HashMap<>();
	...
	/**
	 * Retrieves a {@link java.lang.reflect.Field} instance declared by the specified
	 ...
	 * {@link java.lang.reflect.Field#setAccessible(boolean)} will be invoked with an argument
	...
	/**
	 * Retrieves a {@link java.lang.reflect.Method} instance declared by the specified class
	 ...
	 * {@link java.lang.reflect.Method#setAccessible(boolean)} will be invoked with an argument
	 * of {@code true} before it is returned.  This ensures that callers do not have to check
	 * or worry about Java access modifiers when dealing with the returned instance.
	 *
	...
	public synchronized static Method getMethod(Class<?> clazz, String name, Class<?>... args) {
		...
		Map<String, Map<Wrapper<Class<?>[]>, Method>> loadedMethodNames = loadedMethods.get(clazz);
		if (!loadedMethodNames.containsKey(name)) {
			loadedMethodNames.put(name, new HashMap<>());
		}

		Map<Wrapper<Class<?>[]>, Method> loadedSignatures = loadedMethodNames.get(name);
		Wrapper<Class<?>[]> wrappedArg = new Wrapper<>(args);
